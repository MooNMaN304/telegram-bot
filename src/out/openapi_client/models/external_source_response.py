...
class ExternalSourceResponse(BaseModel):
    ...
    """ # noqa: E501
    total: StrictInt = Field(description="Суммарное кол-во сайтов")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "items": [ExternalSourceResponseItems.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
