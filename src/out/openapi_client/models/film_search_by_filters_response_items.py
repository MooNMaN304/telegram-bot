...
class FilmSearchByFiltersResponseItems(BaseModel):
    ...
    rating_imdb: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ratingImdb")
    ...
    __properties: ClassVar[List[str]] = ["kinopoiskId", "imdbId", "nameRu", "nameEn", "nameOriginal", "countries", "genres", "ratingKinopoisk", "ratingImdb", "year", "type", "posterUrl", "posterUrlPreview"]
