...
class ImageResponse(BaseModel):
    ...
    ImageResponse
    """ # noqa: E501
    total: StrictInt = Field(description="Общее кол-во изображений")
    total_pages: StrictInt = Field(description="Код-во доступных страниц", alias="totalPages")
    items: List[ImageResponseItems]
    __properties: ClassVar[List[str]] = ["total", "totalPages", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ImageResponseItems.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
