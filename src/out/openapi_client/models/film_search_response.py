...
class FilmSearchResponse(BaseModel):
    ...
    """ # noqa: E501
    keyword: StrictStr
    pages_count: StrictInt = Field(alias="pagesCount")
    search_films_count_result: StrictInt = Field(alias="searchFilmsCountResult")
    films: List[FilmSearchResponseFilms]
    __properties: ClassVar[List[str]] = ["keyword", "pagesCount", "searchFilmsCountResult", "films"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searchFilmsCountResult": obj.get("searchFilmsCountResult"),
            "films": [FilmSearchResponseFilms.from_dict(_item) for _item in obj["films"]] if obj.get("films") is not None else None
        })
        return _obj
