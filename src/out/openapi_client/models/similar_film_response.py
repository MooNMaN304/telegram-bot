...
class SimilarFilmResponse(BaseModel):
    """
    SimilarFilmResponse
    """ # noqa: E501
    total: StrictInt
    items: List[SimilarFilmResponseItems]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "total": obj.get("total"),
            "items": [SimilarFilmResponseItems.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
