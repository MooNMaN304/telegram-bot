...
class VideoResponseItems(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "name", "site"]
    ...
    def site_validate_enum(cls, value):
        ...
        if value not in set(['YOUTUBE', 'KINOPOISK_WIDGET', 'YANDEX_DISK', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('YOUTUBE', 'KINOPOISK_WIDGET', 'YANDEX_DISK', 'UNKNOWN')")
        return value
