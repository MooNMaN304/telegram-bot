...
class FilmSequelsAndPrequelsResponse(BaseModel):
    ...
    name_original: StrictStr = Field(alias="nameOriginal")
    ...
    def relation_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SEQUEL', 'PREQUEL', 'REMAKE', 'UNKNOWN']):
            raise ValueError("must be one of enum values ('SEQUEL', 'PREQUEL', 'REMAKE', 'UNKNOWN')")
        return value
