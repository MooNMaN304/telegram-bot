...
class ApiKeyResponseDailyQuota(BaseModel):
    ...
    value: StrictInt
    used: StrictInt
    __properties: ClassVar[List[str]] = ["value", "used"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiKeyResponseDailyQuota from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiKeyResponseDailyQuota from a dict"""
        if obj is None:
            return None
