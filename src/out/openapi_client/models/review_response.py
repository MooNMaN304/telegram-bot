...
class ReviewResponse(BaseModel):
    ...
    ReviewResponse
    """ # noqa: E501
    total: StrictInt = Field(description="Суммарное кол-во пользовательских рецензий")
    total_pages: StrictInt = Field(alias="totalPages")
    total_positive_reviews: StrictInt = Field(alias="totalPositiveReviews")
    total_negative_reviews: StrictInt = Field(alias="totalNegativeReviews")
    total_neutral_reviews: StrictInt = Field(alias="totalNeutralReviews")
    items: List[ReviewResponseItems]
    __properties: ClassVar[List[str]] = ["total", "totalPages", "totalPositiveReviews", "totalNegativeReviews", "totalNeutralReviews", "items"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalPositiveReviews": obj.get("totalPositiveReviews"),
            "totalNegativeReviews": obj.get("totalNegativeReviews"),
            "totalNeutralReviews": obj.get("totalNeutralReviews"),
            "items": [ReviewResponseItems.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
