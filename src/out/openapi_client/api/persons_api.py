...
class PersonsApi:
    ...
    @validate_call
    def api_v1_persons_get(
        self,
        name: Annotated[StrictStr, Field(description="имя человека")],
        page: Annotated[Optional[Annotated[int, Field(le=2, strict=True, ge=1)]], Field(description="номер страницы")] = None,
        ...
        _param = self._api_v1_persons_get_serialize(
            name=name,
            page=page,
    ...
    @validate_call
    def api_v1_persons_get_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="имя человека")],
        page: Annotated[Optional[Annotated[int, Field(le=2, strict=True, ge=1)]], Field(description="номер страницы")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PersonByNameResponse]:
        """поиск актеров, режиссеров и т.д. по имени
    ...
    @validate_call
    def api_v1_persons_get_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="имя человека")],
        page: Annotated[Optional[Annotated[int, Field(le=2, strict=True, ge=1)]], Field(description="номер страницы")] = None,
        _request_timeout: Union[
    ...
    def _api_v1_persons_get_serialize(
        self,
        name,
        page,
        _request_auth,
