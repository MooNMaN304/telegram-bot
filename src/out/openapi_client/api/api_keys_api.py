...
class ApiKeysApi:
    ...
    @validate_call
    def api_v1_api_keys_api_key_get(
        self,
        ...
        _param = self._api_v1_api_keys_api_key_get_serialize(
            api_key=api_key,
    ...
    @validate_call
    def api_v1_api_keys_api_key_get_with_http_info(
        self,
        api_key: Annotated[StrictStr, Field(description="api key")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v1_api_keys_api_key_get_without_preload_content(
        self,
        api_key: Annotated[StrictStr, Field(description="api key")],
        _request_timeout: Union[
            None,
    ...
    def _api_v1_api_keys_api_key_get_serialize(
        self,
        api_key,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/api_keys/{apiKey}',
