...
class MediaPostsApi:
    ...
    def api_v1_media_posts_get(
        ...
        _param = self._api_v1_media_posts_get_serialize(
            page=page,
    ...
    @validate_call
    def api_v1_media_posts_get_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="номер страницы")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MediaPostsResponse]:
        """получить медиа новости с сайта кинопоиск
    ...
    @validate_call
    def api_v1_media_posts_get_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="номер страницы")] = None,
        _request_timeout: Union[
            None,
    ...
    def _api_v1_media_posts_get_serialize(
        self,
        page,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/media_posts',
