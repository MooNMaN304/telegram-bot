...
class TestPersonResponseSpouses(unittest.TestCase):
    """PersonResponseSpouses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonResponseSpouses:
        """Test PersonResponseSpouses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonResponseSpouses`
        """
        model = PersonResponseSpouses()
        if include_optional:
            return PersonResponseSpouses(
                person_id = 32169,
                name = 'Сьюзан Дауни',
                divorced = False,
                divorced_reason = '',
    ...
    def testPersonResponseSpouses(self):
        """Test PersonResponseSpouses"""
