...
class TestReviewResponseItems(unittest.TestCase):
    """ReviewResponseItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReviewResponseItems:
        """Test ReviewResponseItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReviewResponseItems`
        """
        model = ReviewResponseItems()
        if include_optional:
            return ReviewResponseItems(
                kinopoisk_id = 2,
                type = 'POSITIVE',
                var_date = '2010-09-05T20:37:00',
                positive_rating = 122,
                negative_rating = 12,
                author = 'Username',
                title = 'Title',
    ...
    def testReviewResponseItems(self):
        """Test ReviewResponseItems"""
