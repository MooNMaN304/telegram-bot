...
class TestRelatedFilmResponse(unittest.TestCase):
    """RelatedFilmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedFilmResponse:
        """Test RelatedFilmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedFilmResponse`
        """
        model = RelatedFilmResponse()
        if include_optional:
            return RelatedFilmResponse(
                total = 7,
                items = [
                    openapi_client.models.related_film_response_items.RelatedFilmResponse_items(
                        kinopoisk_id = 301, 
                        name_ru = 'Матрица', 
                        name_en = 'The Matrix', 
    ...
    def testRelatedFilmResponse(self):
        """Test RelatedFilmResponse"""
