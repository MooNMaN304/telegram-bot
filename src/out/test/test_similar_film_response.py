...
class TestSimilarFilmResponse(unittest.TestCase):
    """SimilarFilmResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SimilarFilmResponse:
        """Test SimilarFilmResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SimilarFilmResponse`
        """
        model = SimilarFilmResponse()
        if include_optional:
            return SimilarFilmResponse(
                total = 7,
                items = [
                    openapi_client.models.similar_film_response_items.SimilarFilmResponse_items(
                        film_id = 301, 
                        name_ru = 'Матрица', 
                        name_en = 'The Matrix', 
    ...
    def testSimilarFilmResponse(self):
        """Test SimilarFilmResponse"""
