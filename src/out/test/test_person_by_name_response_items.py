...
class TestPersonByNameResponseItems(unittest.TestCase):
    """PersonByNameResponseItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonByNameResponseItems:
        """Test PersonByNameResponseItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonByNameResponseItems`
        """
        model = PersonByNameResponseItems()
        if include_optional:
            return PersonByNameResponseItems(
                kinopoisk_id = 66539,
                web_url = '10096',
    ...
    def testPersonByNameResponseItems(self):
        """Test PersonByNameResponseItems"""
