...
class TestFiltersResponseCountries(unittest.TestCase):
    """FiltersResponseCountries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FiltersResponseCountries:
        """Test FiltersResponseCountries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FiltersResponseCountries`
        """
        model = FiltersResponseCountries()
        if include_optional:
            return FiltersResponseCountries(
                id = 1,
                country = 'США'
            )
        else:
    ...
    def testFiltersResponseCountries(self):
        """Test FiltersResponseCountries"""
