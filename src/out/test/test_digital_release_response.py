...
class TestDigitalReleaseResponse(unittest.TestCase):
    """DigitalReleaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DigitalReleaseResponse:
        """Test DigitalReleaseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DigitalReleaseResponse`
        """
        model = DigitalReleaseResponse()
        if include_optional:
            return DigitalReleaseResponse(
                page = 1,
                total = 34,
                releases = [
                    openapi_client.models.digital_release_item.DigitalReleaseItem(
                        film_id = 301, 
                        name_ru = 'Дитя погоды', 
                        name_en = 'Tenki no ko', 
                        year = 2019, 
    ...
    def testDigitalReleaseResponse(self):
        """Test DigitalReleaseResponse"""
