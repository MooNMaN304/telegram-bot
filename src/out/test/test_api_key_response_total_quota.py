...
class TestApiKeyResponseTotalQuota(unittest.TestCase):
    """ApiKeyResponseTotalQuota unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyResponseTotalQuota:
        """Test ApiKeyResponseTotalQuota
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyResponseTotalQuota`
        """
        model = ApiKeyResponseTotalQuota()
        if include_optional:
            return ApiKeyResponseTotalQuota(
                value = 1000,
                used = 2
            )
        else:
    ...
    def testApiKeyResponseTotalQuota(self):
        """Test ApiKeyResponseTotalQuota"""
