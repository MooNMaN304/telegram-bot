    ...
    def make_instance(self, include_optional) -> ApiKeyResponse:
        ...
        if include_optional:
            return ApiKeyResponse(
                total_quota = openapi_client.models.api_key_response_total_quota.ApiKeyResponse_totalQuota(
                    value = 1000, 
                    used = 2, ),
                daily_quota = openapi_client.models.api_key_response_daily_quota.ApiKeyResponse_dailyQuota(
                    value = 500, 
                    used = 2, ),
                account_type = 'FREE'
            )
