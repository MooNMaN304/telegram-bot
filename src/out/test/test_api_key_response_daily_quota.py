...
class TestApiKeyResponseDailyQuota(unittest.TestCase):
    """ApiKeyResponseDailyQuota unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiKeyResponseDailyQuota:
        """Test ApiKeyResponseDailyQuota
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiKeyResponseDailyQuota`
        """
        model = ApiKeyResponseDailyQuota()
        if include_optional:
            return ApiKeyResponseDailyQuota(
                value = 500,
                used = 2
            )
        else:
    ...
    def testApiKeyResponseDailyQuota(self):
        """Test ApiKeyResponseDailyQuota"""
