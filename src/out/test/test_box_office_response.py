...
class TestBoxOfficeResponse(unittest.TestCase):
    """BoxOfficeResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BoxOfficeResponse:
        """Test BoxOfficeResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BoxOfficeResponse`
        """
        model = BoxOfficeResponse()
        if include_optional:
            return BoxOfficeResponse(
                total = 5,
                items = [
                    openapi_client.models.box_office.BoxOffice(
                        type = 'BUDGET', 
                        amount = 63000000, 
                        currency_code = 'USD', 
                        name = 'US Dollar', 
    ...
    def testBoxOfficeResponse(self):
        """Test BoxOfficeResponse"""
