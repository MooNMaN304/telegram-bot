...
class TestFilmCollectionResponse(unittest.TestCase):
    """FilmCollectionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilmCollectionResponse:
        """Test FilmCollectionResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilmCollectionResponse`
        """
        model = FilmCollectionResponse()
        if include_optional:
            return FilmCollectionResponse(
                total = 200,
                total_pages = 7,
                items = [
                    openapi_client.models.film_collection_response_items.FilmCollectionResponse_items(
                        kinopoisk_id = 263531, 
                        name_ru = 'Мстители', 
    ...
    def testFilmCollectionResponse(self):
        """Test FilmCollectionResponse"""
