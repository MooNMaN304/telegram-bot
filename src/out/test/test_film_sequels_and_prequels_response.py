...
class TestFilmSequelsAndPrequelsResponse(unittest.TestCase):
    """FilmSequelsAndPrequelsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilmSequelsAndPrequelsResponse:
        """Test FilmSequelsAndPrequelsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilmSequelsAndPrequelsResponse`
        """
        model = FilmSequelsAndPrequelsResponse()
        if include_optional:
    ...
    def testFilmSequelsAndPrequelsResponse(self):
        """Test FilmSequelsAndPrequelsResponse"""
