...
class TestImageResponseItems(unittest.TestCase):
    """ImageResponseItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ImageResponseItems:
        """Test ImageResponseItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ImageResponseItems`
        """
        model = ImageResponseItems()
        if include_optional:
            return ImageResponseItems(
    ...
    def testImageResponseItems(self):
        """Test ImageResponseItems"""
