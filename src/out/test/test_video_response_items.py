...
class TestVideoResponseItems(unittest.TestCase):
    """VideoResponseItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VideoResponseItems:
        """Test VideoResponseItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoResponseItems`
        """
        model = VideoResponseItems()
        if include_optional:
            return VideoResponseItems(
    ...
    def testVideoResponseItems(self):
        """Test VideoResponseItems"""
