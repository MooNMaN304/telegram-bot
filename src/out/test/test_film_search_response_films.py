...
class TestFilmSearchResponseFilms(unittest.TestCase):
    """FilmSearchResponseFilms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilmSearchResponseFilms:
        """Test FilmSearchResponseFilms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilmSearchResponseFilms`
        """
        model = FilmSearchResponseFilms()
        if include_optional:
            return FilmSearchResponseFilms(
                film_id = 263531,
                name_ru = 'Мстители',
    ...
    def testFilmSearchResponseFilms(self):
        """Test FilmSearchResponseFilms"""
