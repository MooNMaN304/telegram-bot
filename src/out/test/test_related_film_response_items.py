...
class TestRelatedFilmResponseItems(unittest.TestCase):
    """RelatedFilmResponseItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedFilmResponseItems:
        """Test RelatedFilmResponseItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedFilmResponseItems`
        """
        model = RelatedFilmResponseItems()
        if include_optional:
            return RelatedFilmResponseItems(
                kinopoisk_id = 301,
                name_ru = 'Матрица',
                name_en = 'The Matrix',
    ...
    def testRelatedFilmResponseItems(self):
        """Test RelatedFilmResponseItems"""
