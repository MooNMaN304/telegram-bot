...
from src.out.openapi_client.api.kp_users_api import KpUsersApi


class TestKpUsersApi(unittest.TestCase):
    """KpUsersApi unit test stubs"""
    ...
    def test_api_v1_kp_users_id_votes_get(self) -> None:
        """Test case for api_v1_kp_users_id_votes_get
