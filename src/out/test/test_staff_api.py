...
from src.out.openapi_client.api.staff_api import StaffApi
...
class TestStaffApi(unittest.TestCase):
    ...
    def test_api_v1_staff_get(self) -> None:
        """Test case for api_v1_staff_get

        получить данные об актерах, режисерах и т.д. по kinopoisk film id
        """
        pass

    def test_api_v1_staff_id_get(self) -> None:
        """Test case for api_v1_staff_id_get
