...
class TestPremiereResponse(unittest.TestCase):
    """PremiereResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PremiereResponse:
        """Test PremiereResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PremiereResponse`
        """
        model = PremiereResponse()
        if include_optional:
            return PremiereResponse(
                total = 34,
                items = [
                    openapi_client.models.premiere_response_item.PremiereResponseItem(
                        kinopoisk_id = 301, 
                        name_ru = 'Дитя погоды', 
                        name_en = 'Tenki no ko', 
                        year = 2019, 
