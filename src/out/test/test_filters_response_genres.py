...
class TestFiltersResponseGenres(unittest.TestCase):
    """FiltersResponseGenres unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FiltersResponseGenres:
        """Test FiltersResponseGenres
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FiltersResponseGenres`
        """
        model = FiltersResponseGenres()
        if include_optional:
            return FiltersResponseGenres(
                id = 1,
                genre = 'боевик'
            )
        else:
    ...
    def testFiltersResponseGenres(self):
        """Test FiltersResponseGenres"""
