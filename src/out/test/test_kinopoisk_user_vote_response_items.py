...
class TestKinopoiskUserVoteResponseItems(unittest.TestCase):
    """KinopoiskUserVoteResponseItems unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KinopoiskUserVoteResponseItems:
        """Test KinopoiskUserVoteResponseItems
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KinopoiskUserVoteResponseItems`
        """
        model = KinopoiskUserVoteResponseItems()
        if include_optional:
            return KinopoiskUserVoteResponseItems(
                kinopoisk_id = 263531,
                name_ru = 'Мстители',
    ...
    def testKinopoiskUserVoteResponseItems(self):
        """Test KinopoiskUserVoteResponseItems"""
