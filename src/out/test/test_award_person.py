...
class TestAwardPerson(unittest.TestCase):
    """AwardPerson unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AwardPerson:
        """Test AwardPerson
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AwardPerson`
        """
        model = AwardPerson()
        if include_optional:
            return AwardPerson(
