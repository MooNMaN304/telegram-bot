...
class TestFilmSearchByFiltersResponse(unittest.TestCase):
    """FilmSearchByFiltersResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FilmSearchByFiltersResponse:
        """Test FilmSearchByFiltersResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FilmSearchByFiltersResponse`
        """
        model = FilmSearchByFiltersResponse()
        if include_optional:
            return FilmSearchByFiltersResponse(
                total = 7,
                total_pages = 1,
                items = [
                    openapi_client.models.film_search_by_filters_response_items.FilmSearchByFiltersResponse_items(
                        kinopoisk_id = 263531, 
                        imdb_id = 'tt0050561', 
                        name_ru = 'Мстители', 
    ...
    def testFilmSearchByFiltersResponse(self):
        """Test FilmSearchByFiltersResponse"""
