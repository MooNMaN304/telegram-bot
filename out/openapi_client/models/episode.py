...
class Episode(BaseModel):
    ...
    Episode
    """ # noqa: E501
    season_number: StrictInt = Field(alias="seasonNumber")
    episode_number: StrictInt = Field(alias="episodeNumber")
    name_ru: Optional[StrictStr] = Field(alias="nameRu")
    name_en: Optional[StrictStr] = Field(alias="nameEn")
    synopsis: Optional[StrictStr]
    release_date: Optional[StrictStr] = Field(alias="releaseDate")
    __properties: ClassVar[List[str]] = ["seasonNumber", "episodeNumber", "nameRu", "nameEn", "synopsis", "releaseDate"]
