...
# **api_v1_persons_get**
> PersonByNameResponse api_v1_persons_get(name, page=page)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    name = 'name_example' # str | имя человека
    page = 1 # int | номер страницы (optional) (default to 1)

    try:
        # поиск актеров, режиссеров и т.д. по имени
        api_response = api_instance.api_v1_persons_get(name, page=page)
        print("The response of PersonsApi->api_v1_persons_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PersonsApi->api_v1_persons_get: %s\n" % e)
```
...
**429** | Слишком много запросов. Общий лимит - 5 запросов в секунду |  -  |
